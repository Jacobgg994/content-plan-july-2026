...
| # | วัน | Broadcast |
|---|-----|-----------|
| 1 | อ | "เดือนนี้คุณ automate ได้ — โดยไม่ต้องเขียนโค้ด 🤝 — ✅ ทดลองฟรี 14 วัน ✅ สอนใช้ทุกอังคาร ✅ support ภาษาไทย" |
...
| # | วัน | Broadcast |
|---|-----|-----------|
| 1 | อ | "🎁 ทดลองฟรี 30 วัน (ปกติ 14) — เฉพาะสมาชิก LINE เท่านั้น! [ปุ่ม: รับสิทธิ์ 30 วัน]" |
| 2 | พฤ | "🛠 3 Workflow ยอดฮิต — ตั้งเวลาโพสต์, เก็บ lead, auto reply [ปุ่ม: ดูวิธีตั้งค่า]" |
| 3 | ส | "📊 2,800+ คน automate แล้ว — คุณล่ะ? [ปุ่ม: เริ่มทดลองฟรี]" |
